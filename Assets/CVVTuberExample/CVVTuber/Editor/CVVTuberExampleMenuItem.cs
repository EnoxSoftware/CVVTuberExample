    ...
    public class CVVTuberExampleMenuItem : MonoBehaviour
    {
        ...
        public static void SetCVVTuberSettings ()
        {
            ...
            if (cVVTuberModel != null) {
                ...
                DlibFaceBlendShapeController dlibFaceBlendShapeController = FindObjectOfType<DlibFaceBlendShapeController> ();
                if (dlibFaceBlendShapeController != null) {
                    Undo.RecordObject(dlibFaceBlendShapeController, "Set SkinnedMeshRenderer to dlibFaceBlendShapeController");
                    dlibFaceBlendShapeController.FACE_DEF = cVVTuberModel.transform.Find ("FACE_DEF").GetComponent<SkinnedMeshRenderer> ();
                }
